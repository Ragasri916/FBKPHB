...
public class BaseNP {
	...
	public	static String  url="https://www.facebook.com/";
		public static void Init_browser()
		{
			...
			{	
			case "IE":
				System.setProperty("webdriver.IE.driver","D:\\KPHP\\InternetExplorer.exe");
		...
		public static void Application_url(String url) throws Exception
		{
			if(  (url.indexOf("https")!=0) || (url.length()==0)   )
	                  {
	                      throw new Exception("Invalid url..please check it");	
	                  }
			driver.get(url);
